...
### Tasks: To automate the stopping and starting of EC2 instances based on tags.
...
1. In the IAM dashboard, create a new role for Lambda and attach the `AmazonEC2FullAccess` `AWSLambdaBasicExecutionRole` policy to this role.  <img width="1552" height="681" alt="image" src="https://github.com/user-attachments/assets/46d7767a-c095-4c25-b07b-95bb0113dd94" />
